 ...
 * distributed with iG:Syntax Hiliter(currently as I know of it)
 * -------------------------------------------------------------------------------
 *
 * CHANGES
 * -------
 * 2005/06/29 (1.1)
 *   -  Made some structural changes to match the current GeSHi(v1.0.7) language
 *      file structure
 * 2004/11/09 (1.0)
 *  -  First Release
 *
...
$language_data = array (
	...
	'STYLES' => array(
		'KEYWORDS' => array(),
		'COMMENTS' => array(
			1 => 'color:#FF9933; font-style:italic;',
			'MULTI' => 'color:#008000;'
			),
		'ESCAPE_CHAR' => array(
