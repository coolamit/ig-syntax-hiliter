...
* NEW: A live preview on the settings page. A sample code box sits beside the settings and repaints as you change them, so picking one of 43 themes no longer means saving it, opening your site and coming back. The theme, the toolbar, the copy button and the line numbers all show in it. Nothing in the preview is saved.
