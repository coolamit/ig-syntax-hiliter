...
* CHANGED: Where the `file` label appears. With the toolbar on it sits in the toolbar, which Prism fades in on hover or keyboard focus rather than drawing into the box the way v5 did. With the toolbar off it is painted in the top right corner of the code box and is always visible — in v5, turning the toolbar off hid the file label along with it.
